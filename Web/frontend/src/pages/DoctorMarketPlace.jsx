...
export const DoctorMarketPlace = () => {
  ...
  const filteredCaregivers = initialCaregivers.filter(initialCaregiver => {
    return (
      (filters.experience ? initialCaregiver.experience === filters.experience : true) &&
      (filters.location ? initialCaregiver.location === filters.location : true) &&
      (filters.specialization ? initialCaregiver.specializations.includes(filters.specialization) : true)
    );
  });
